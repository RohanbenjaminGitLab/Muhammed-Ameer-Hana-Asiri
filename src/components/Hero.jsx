    ...
    const handleTyping = () => {
      if (!isDeleting) {
        ...
        if (displayedText === "") {
          ...
          setSpeed(500); // Brief pause before starting next role
        }
      }
    };
      ...
      <div className="max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-12 gap-12 items-center relative z-10">
        ...
        <div className="lg:col-span-7 flex flex-col items-center lg:items-start text-center lg:text-left">
          ...
          <motion.div
            ...
            className="inline-block px-4 py-1.5 rounded-full glass-card-light dark:glass-card-dark text-xs md:text-sm font-semibold text-primary-600 dark:text-secondary-400 mb-6 uppercase tracking-wider"
          >
          ...
          <motion.p
            ...
            className="text-base md:text-lg text-slate-600 dark:text-slate-355 max-w-xl mb-8 leading-relaxed"
          >
        ...
        <div className="lg:col-span-5 flex justify-center relative">
          ...
          >
            ...
            <div className="absolute inset-0 rounded-full overflow-hidden border-4 border-white dark:border-slate-850 shadow-2xl glass-card-light dark:glass-card-dark">
              <img
                ...
                onError={(e) => {
                  ...
                  e.target.src = "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?fit=crop&w=500&h=500&q=80"; // High-quality fallback portrait
                }}
              />
            </div>

            {/* Glowing floated badges */}
            <motion.div
              animate={{ y: [0, -10, 0] }}
            ...
            <motion.div
              ...
              className="absolute -bottom-4 -left-4 px-4 py-2 rounded-2xl glass-card-light dark:glass-card-dark text-xs md:text-sm font-semibold flex items-center gap-2 shadow-lg"
            >
